...
<template>
  <div>
    ...
    >
      ...
      >
        <div class="flex items-center">
          <img class="rounded-full" width="27" :src="profilePic" />
    ...
    <div id="SideNav" class="h-[100%] p-6 w-[240px] fixed z-50 bg-black">
      <RouterLink to="/" class="flex items-center mb-8">
        <img src="/musicLogo.png" alt="TuneIT Logo" class="w-8 h-8 mr-2" />
        <div class="text-white text-2xl font-bold">TuneIT</div>
      </RouterLink>
